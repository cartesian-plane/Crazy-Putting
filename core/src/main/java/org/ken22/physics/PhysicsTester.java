...
//        org.ken22.physics.Engine.PhysicsEngine test1 = new org.ken22.physics.Engine.PhysicsEngine((Math.PI)/2,(Math.PI)/2,0.5,0.5, 0.001, 0, 1, 0.1, 0.2, 9.80665, testFunc1, "sin");
//        testSystem(test1);
//
